...
from train.training_prpl import train
...
def main(
    ...
    batch_size: Annotated[int, typer.Option(
        help='batch size for training')] = 96,
    ...
    random_seed: Annotated[int | None, typer.Option(
        help='random seed for reproducibility, None for no seed')] = 20,
    ...
    for session_id in range(num_sessions):
        for subject_id in subject_ids:
            ...
            model = MODEL[cli_enum.ModelName.PRPL](
                num_electrodes,
                num_features,
                num_classes,
                max_iter=epochs,
