...
from reference.NSAL_DGAT_Training import train
from reference.NSAL_DGAT import Discriminator, DAANLoss
import torch
...
# uv run ./LibEER/NSAL_DGAT_train.py -dataset seed_de_lds -dataset_path ../data/SEED -setting seed_sub_dependent_front_back_setting -device cuda:0 -epochs 60 -batch_size 128